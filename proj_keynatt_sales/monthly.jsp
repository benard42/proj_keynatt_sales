		   ...
		   <tr class="notfound"><td >
			...
			try{
		     String url = "jdbc:mysql://localhost:3306/shopdatabase"; 
            		...
            		ResultSet rs = st.executeQuery("SELECT `Date`, `Branch`, `BagName`, `BagID`, `SaleQntty`, sum(TotalAmount), `SalesPerson`, `Week`,`Day`, `Month` FROM `Sales` WHERE 1 group BY Branch, Month");  
            			 %>
