...
<body>
		...
		<div class="notfound">
		   <tr class="notfound"><td >
				<a href="overallsales.jsp><br><br></td>
			...
			try{
		     String url = "jdbc:mysql://localhost:3306/shopdatabase"; 
            		...
            		ResultSet rs = st.executeQuery("SELECT `Date`, `Branch`, `BagName`, `BagID`, `SaleQntty`, sum(TotalAmount), `SalesPerson`, `Week`,`Day`, `Month` FROM `Sales` WHERE 1 group BY Branch, Week");  
            			 %>
