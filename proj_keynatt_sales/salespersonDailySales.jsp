		   ...
		   <tr class="notfound"><td >
			...
			try{
		     String url = "jdbc:mysql://localhost:3306/shopdatabase"; 
            			...
            			ResultSet rs = st.executeQuery("SELECT `Date`, `Branch`, `BagName`, `BagID`, sum(SaleQntty), sum(TotalAmount), `salesperson`, `Week`,`Day` FROM `Sales` WHERE Branch='"+ss+"' GROUP BY `Date`");  
            			 %>
